...
const Footer = () => {
    return (
        <footer className="relative w-full min-h-[400px] sm:min-h-[320px] bg-footer bg-contain bg-no-repeat bg-center z-0 overflow-hidden font-custom2 text-gray-300 px-2 pb-1">
